...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', choices=['train', 'test'], default='train',
                        help='choose training the neural network or testing it.')
    parser.add_argument('--print_model', default="False", help='print the model summary.')
    parser.add_argument('--hidden_channel', type=int, default=12,
                        help='number of hidden channels in the second convolutional layer.')
    parser.add_argument('--hidden_linear', type=int, default=120,
                        help='number of hidden neurons in the first fully connected layer.')
    ...
    MODEL_NAME = "lenet_mnist" + "_lr_" + str(args.learning_rate) + "_wd_" + str(args.weight_decay) + "_" + str(
        args.hidden_channel) + "_" + str(args.hidden_linear) + ".pth"
    MODEL_SAVE_PATH = MODEL_PATH / MODEL_NAME
    if args.print_model == "True":
        # Summary of the model
        print(summary(model=modellenet.to(DEVICE), input_size=(1, 1, 28, 28), col_width=20,
